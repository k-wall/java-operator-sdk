 ...
 */
public class OptionalApiBulkDependentResource
    extends KubernetesDependentResource<Route, BulkActivationConditionCustomResource>
    implements CRUDKubernetesBulkDependentResource<Route, BulkActivationConditionCustomResource> {
  ...
  @Override
  public Map<ResourceID, Route> getSecondaryResources(
      BulkActivationConditionCustomResource primary,
      Context<BulkActivationConditionCustomResource> context) {
